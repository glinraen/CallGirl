class TaskListsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @task_list.save
        format.html { redirect_to @task_list, notice: 'Todo list was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @task_list.update(task_list_params)
        format.html { redirect_to @task_list, notice: 'Todo list was successfully updated.' }
